        ...
        <div className="container mx-auto px-4 py-16 lg:px-8 lg:py-24">
          <div className="max-w-3xl">
            ...
            <p className="text-base md:text-lg text-muted-foreground leading-relaxed">
              Use the form below to get in touch about research, market narratives, potential collaborations, or general
              questions about Catalyst Wire. A member of our team will review your note and follow up as appropriate.
            </p>
          </div>
        </div>
      </section>
